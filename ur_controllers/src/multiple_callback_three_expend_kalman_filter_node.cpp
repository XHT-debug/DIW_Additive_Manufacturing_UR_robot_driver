...
rclcpp::Publisher<std_msgs::msg::Float64MultiArray>::SharedPtr callback3_expend_kalman_filter_pub;

class MultipleCallbackThreeExpendKalmanFilterSubscriber : public rclcpp::Node
{
public:
    MultipleCallbackThreeExpendKalmanFilterSubscriber()
        : Node("expend_kalman_filter_three")  // 设置节点名称
    {
        ...
        expend_kalman_filter_result_k_1_sub = this->create_subscription<std_msgs::msg::Float64MultiArray>(
            ...
            std::bind(&MultipleCallbackThreeExpendKalmanFilterSubscriber::expend_kalman_filter_result_k_1_callback, this, std::placeholders::_1));

        callback3_expend_kalman_filter_pub = this->create_publisher<std_msgs::msg::Float64MultiArray>("/callback3_expend_kalman_filter", 10);
    }
...
private:
    ...
    void expend_kalman_filter_result_k_1_callback(const std_msgs::msg::Float64MultiArray::SharedPtr msg) {
        ...
        callback3_expend_kalman_filter_pub->publish(msg_send);
    }
...
int main(int argc, char *argv[])
{
    ...
    auto node = std::make_shared<MultipleCallbackThreeExpendKalmanFilterSubscriber>();  // 创建订阅者节点
