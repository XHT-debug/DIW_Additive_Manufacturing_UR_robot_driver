...
rclcpp::Publisher<std_msgs::msg::Float64MultiArray>::SharedPtr callback8_expend_kalman_filter_pub;

class MultipleCallbackEightExpendKalmanFilterSubscriber : public rclcpp::Node
{
public:
    MultipleCallbackEightExpendKalmanFilterSubscriber()
        : Node("expend_kalman_filter_eight")  // 设置节点名称
    {
        ...
        expend_kalman_filter_result_k_1_sub = this->create_subscription<std_msgs::msg::Float64MultiArray>(
            ...
            std::bind(&MultipleCallbackEightExpendKalmanFilterSubscriber::expend_kalman_filter_result_k_1_callback, this, std::placeholders::_1));

        callback8_expend_kalman_filter_pub = this->create_publisher<std_msgs::msg::Float64MultiArray>("/callback8_expend_kalman_filter", 10);
    }
...
private:
    ...
    void expend_kalman_filter_result_k_1_callback(const std_msgs::msg::Float64MultiArray::SharedPtr msg) {
        ...
        callback8_expend_kalman_filter_pub->publish(msg_send);
    }
...
int main(int argc, char *argv[])
{
    ...
    auto node = std::make_shared<MultipleCallbackEightExpendKalmanFilterSubscriber>();  // 创建订阅者节点
