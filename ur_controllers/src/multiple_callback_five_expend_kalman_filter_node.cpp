...
rclcpp::Publisher<std_msgs::msg::Float64MultiArray>::SharedPtr callback5_expend_kalman_filter_pub;

class MultipleCallbackFiveExpendKalmanFilterSubscriber : public rclcpp::Node
{
public:
    MultipleCallbackFiveExpendKalmanFilterSubscriber()
        : Node("expend_kalman_filter_five")  // 设置节点名称
    {
        ...
        expend_kalman_filter_result_k_1_sub = this->create_subscription<std_msgs::msg::Float64MultiArray>(
            ...
            std::bind(&MultipleCallbackFiveExpendKalmanFilterSubscriber::expend_kalman_filter_result_k_1_callback, this, std::placeholders::_1));

        callback5_expend_kalman_filter_pub = this->create_publisher<std_msgs::msg::Float64MultiArray>("/callback5_expend_kalman_filter", 10);
    }
...
private:
    ...
    void expend_kalman_filter_result_k_1_callback(const std_msgs::msg::Float64MultiArray::SharedPtr msg) {
        ...
        callback5_expend_kalman_filter_pub->publish(msg_send);
    }
...
int main(int argc, char *argv[])
{
    ...
    auto node = std::make_shared<MultipleCallbackFiveExpendKalmanFilterSubscriber>();  // 创建订阅者节点
