...
rclcpp::Publisher<std_msgs::msg::Float64MultiArray>::SharedPtr callback4_expend_kalman_filter_pub;

class MultipleCallbackFourExpendKalmanFilterSubscriber : public rclcpp::Node
{
public:
    MultipleCallbackFourExpendKalmanFilterSubscriber()
        : Node("expend_kalman_filter_four")  // 设置节点名称
    {
        ...
        expend_kalman_filter_result_k_1_sub = this->create_subscription<std_msgs::msg::Float64MultiArray>(
            ...
            std::bind(&MultipleCallbackFourExpendKalmanFilterSubscriber::expend_kalman_filter_result_k_1_callback, this, std::placeholders::_1));

        callback4_expend_kalman_filter_pub = this->create_publisher<std_msgs::msg::Float64MultiArray>("/callback4_expend_kalman_filter", 10);
    }
...
private:
    ...
    void expend_kalman_filter_result_k_1_callback(const std_msgs::msg::Float64MultiArray::SharedPtr msg) {
        ...
        callback4_expend_kalman_filter_pub->publish(msg_send);
    }
...
int main(int argc, char *argv[])
{
    ...
    auto node = std::make_shared<MultipleCallbackFourExpendKalmanFilterSubscriber>();  // 创建订阅者节点
