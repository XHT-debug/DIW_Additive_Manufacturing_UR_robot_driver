...
rclcpp::Publisher<std_msgs::msg::Float64MultiArray>::SharedPtr callback9_expend_kalman_filter_pub;

class MultipleCallbackNineExpendKalmanFilterSubscriber : public rclcpp::Node
{
public:
    MultipleCallbackNineExpendKalmanFilterSubscriber()
        : Node("expend_kalman_filter_nine")  // 设置节点名称
    {
        ...
        expend_kalman_filter_result_k_1_sub = this->create_subscription<std_msgs::msg::Float64MultiArray>(
            ...
            std::bind(&MultipleCallbackNineExpendKalmanFilterSubscriber::expend_kalman_filter_result_k_1_callback, this, std::placeholders::_1));

        callback9_expend_kalman_filter_pub = this->create_publisher<std_msgs::msg::Float64MultiArray>("/callback9_expend_kalman_filter", 10);
    }
...
private:
    ...
    void expend_kalman_filter_result_k_1_callback(const std_msgs::msg::Float64MultiArray::SharedPtr msg) {
        ...
        callback9_expend_kalman_filter_pub->publish(msg_send);
    }
...
int main(int argc, char *argv[])
{
    ...
    auto node = std::make_shared<MultipleCallbackNineExpendKalmanFilterSubscriber>();  // 创建订阅者节点
