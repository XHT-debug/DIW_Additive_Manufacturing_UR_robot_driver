...
rclcpp::Publisher<std_msgs::msg::Float64MultiArray>::SharedPtr callback7_expend_kalman_filter_pub;

class MultipleCallbackSevenExpendKalmanFilterSubscriber : public rclcpp::Node
{
public:
    MultipleCallbackSevenExpendKalmanFilterSubscriber()
        : Node("expend_kalman_filter_seven")  // 设置节点名称
    {
        ...
        expend_kalman_filter_result_k_1_sub = this->create_subscription<std_msgs::msg::Float64MultiArray>(
            ...
            std::bind(&MultipleCallbackSevenExpendKalmanFilterSubscriber::expend_kalman_filter_result_k_1_callback, this, std::placeholders::_1));

        callback7_expend_kalman_filter_pub = this->create_publisher<std_msgs::msg::Float64MultiArray>("/callback7_expend_kalman_filter", 10);
    }
...
private:
    ...
    void expend_kalman_filter_result_k_1_callback(const std_msgs::msg::Float64MultiArray::SharedPtr msg) {
        ...
        callback7_expend_kalman_filter_pub->publish(msg_send);
    }
...
int main(int argc, char *argv[])
{
    ...
    auto node = std::make_shared<MultipleCallbackSevenExpendKalmanFilterSubscriber>();  // 创建订阅者节点
